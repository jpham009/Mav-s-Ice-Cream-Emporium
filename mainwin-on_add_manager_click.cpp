...
void Mainwin::add_manager(){


    Gtk::Dialog dialog{"Add Manager", *this};
	...
	Mice::Manager new_manager(e_name.get_text(), e_phone.get_text(), std::to_string(employee_id), d_salary);
		_emp->add_manager(new_manager);
